...
using iam_tennant.Domain.Constants;
using Microsoft.EntityFrameworkCore;

namespace iam_tennant.Infrastructure.Data;

public static class DatabaseSeeder
{
    public static async Task SeedPermissionsAndRolesAsync(AppDbContext context, Guid tenantId)
    {
